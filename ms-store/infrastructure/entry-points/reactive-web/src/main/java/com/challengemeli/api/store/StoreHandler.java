...
import com.challengemeli.api.store.dto.StoreUpdateDTO;
...
public class StoreHandler {
    ...
    public Mono<ServerResponse> getStoreById(ServerRequest request) {
    ...
    public Mono<ServerResponse> updateStore(ServerRequest request){
        UUID storeId = UUID.fromString(request.pathVariable("id"));
        return request.bodyToMono(StoreUpdateDTO.class)
                .flatMap(storeUpdateDTO ->
                        storeUseCase.updateStore( storeId, storeUpdateDTO.getStoreName(),storeUpdateDTO.getLocation()))
